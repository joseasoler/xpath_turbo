...
Please use the [issue tracker](https://github.com/joseasoler/xpath_turbo/issues) or the [bug reports thread in the Steam Workshop](https://steamcommunity.com/workshop/filedetails/discussion/ToDo/ToDo/) to report bugs.

Questions
---

Questions about the mod can be asked in the discussion thread of the mod in the [Steam Workshop](https://steamcommunity.com/sharedfiles/filedetails/?id=ToDo) or using the [issue tracker](https://github.com/joseasoler/xpath_turbo/issues).


Contributions
---

The project and its contributions are managed using the [GitLab Flow](https://docs.gitlab.com/ee/topics/gitlab_flow.html). Before submitting a merge request for a feature, create an issue on the [tracker](https://github.com/joseasoler/xpath_turbo/issues) to allow for discussing and refining the idea prior to its implementation.
